...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative border border-[#00FF4F] h-8 w-full grow overflow-hidden rounded-full bg-inherit">
      <SliderPrimitive.Range className="absolute h-full bg-[#00FF4F]" />
